...
const translations: Record<Language, Record<string, string>> = {
  ro: {
    ...
    "hero.financialSupportDesc": "Sprijin financiar suplimentar de 500 euro/lună pentru participarea la mobilități Erasmus+",
  ...
  en: {
    ...
    "hero.financialSupportDesc": "Additional financial support of 500 euro/month for participation in Erasmus+ mobilities",
