...
const translations: Record<Language, Record<string, string>> = {
  ro: {
    ...
    "howToApply.doc8c": "are calitatea de unic părinte (care își crește singur copilul minor din motive de deces, dispariție, încarcerare a celuilalt părinte sau nerecunoaștere prin certificatul de naștere);",
    "howToApply.doc8d": "are statut de migrant sau refugiat.",
